...
function ToDoList(props) {
    ...
    // console.log('data from todolist id',props.setGetId);
    // console.log('data from todolist setTodoData',props.setTodoData);
    // console.log('data from todolist setshowform',props.setShowForm);
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 relative top-[100px] p-2 gap-2 md:gap-4'>
                        {
                            props.todoData.map((e) => {
                                return (
                                    <ToDoItem key={e.id} id={e.id} setGetId={props.setGetId} tododata={e} setTododata={props.setTodoData} setEdit={props.setEdit} />
                                )
                            })
                        }
                    </div>
